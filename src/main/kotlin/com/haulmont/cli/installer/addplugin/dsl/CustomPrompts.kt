...
package com.haulmont.cli.installer.addplugin.dsl
...
import com.haulmont.cuba.cli.prompting.*
...
/**
 * Copied from CLI core
 */
class CustomPrompts constructor(private val questionsList: QuestionsList) {
